...
<head>
    ...
    <title>Rukit Jakarta Selatan</title>
    <!-- Leaflet CSS -->
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href=" {{ route('table-point') }}">Rumah Sakit</a></li>
                    ...
                    @if (Auth::check())
                    <li class="nav-item">
                      <a class="nav-link" href="{{ route('dashboard') }}"><i class="fa-solid fa-gauge-high"></i></i>Dashboard</a>
                    </li>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <p>Prodi: Sistem Informasi Geografis</p>
                </div>
